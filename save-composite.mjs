...
const URL = "http://localhost:4444/gen-composite.html";
...
console.log("Loading gen-composite.html...");
await page.goto(URL, { waitUntil: "domcontentloaded", timeout: 120000 });

console.log("Waiting for composite sprite generation...");
...
console.log(`Done! ${sprites.length} composite PNGs saved to ${OUT}`);
await browser.close();
