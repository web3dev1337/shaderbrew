...
document.querySelectorAll("#preset-bar button").forEach(b=>{b.style.background="#1a1a2e";b.style.borderColor="#555"});
btn.style.background="#0f3460";btn.style.borderColor="#e94560";
loadPreset(name);
});
bar.appendChild(btn);
});
...
// Auto-load from URL param or default to first preset
const url=new URL(window.location.href);
const preset=url.searchParams.get("preset")||PRESETS[0];
loadPreset(preset);
setTimeout(()=>{const first=bar.querySelector("button");if(first){first.style.background="#0f3460";first.style.borderColor="#e94560"}},100);
})();
