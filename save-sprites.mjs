...
const URL = "http://localhost:4444/gen-sprites.html";
...
console.log("Loading gen-sprites.html...");
await page.goto(URL, { waitUntil: "domcontentloaded", timeout: 120000 });

console.log("Waiting for sprite generation...");
...
console.log(`Done! ${sprites.length} PNGs saved to ${OUT}`);
await browser.close();
